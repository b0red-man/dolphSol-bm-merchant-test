...
useItem(itemName, useAmount := 1) {
    ...
    if (itemName == "Merchant Teleport") {
        if (!containsText((pX + (width*0.81)), (pY + (height*0.75)), 250, 50, "Failed")) {
            handlePause()
            MouseClick
            Sleep, 1000
            Send e
            Sleep, 1000
            if(containsText((pX + (width*0.37)), (pY + (height*0.50)), 500, 80, "Mari")) {
                screenshot()
                Sleep, 7000
                MouseMove, (pX + (width*0.275)), (pY + (height*0.79))
                MouseClick
                Sleep, 1000
                screenshot()
                handlePause()
            ...
            if(containsText((pX + (width*0.37)), (pY + (height*0.50)), 500, 80, "Jester")) {
                screenshot()
                Sleep, 15000
                MouseMove, (pX + (width*0.275)), (pY + (height*0.79))
                MouseClick
...
screenshot() {
    ...
    Gdip_SaveBitmapToFile(ssMap,ssPath)
    Gdip_DisposeBitmap(ssMap)
    webhookPost({files:[ssPath],embedImage:"attachment://ss.jpg",embedTitle: "merchant, hopefully :fish:"})
}
...
F8::
    getRobloxPos(pX, pY, width, height)
    containsText((pX + (width*0.37)), (pY + (height*0.50)), 500, 80, "Mari")
    containsText((pX + (width*0.275)), (pY + (height*0.81)), 160, 70, "Open")
